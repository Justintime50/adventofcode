def main():
    ...
    depth_increases_groups = calculate_depth_increase(data, chunk_size=3)

    print(depth_increases, depth_increases_groups)


def open_file():
    with open('adventofcode/input_data/twentytwentyone/day1.txt', 'r') as f:
        lines = f.read()
